...
public class Staff
{
   ...
   public Staff ()
   {
      ...
      staffList[1] = new Employee("Paulie", "456 Off Line",
         "555-0101", "987-65-4321", 1246.15 , 1);
      staffList[2] = new Employee("Vito", "789 Off Rocker",
         "555-0000", "010-20-3040", 1169.23, 1);

      staffList[3] = new Hourly("Michael", "678 Fifth Ave.",
         "555-0690", "958-47-3625", 10.55 , 3);
   ...
   vacationOption = staffList[count].vacation(); //another polymorphism
   System.out.println (staffList[count]);

   if (vacationOption==0){
      System.out.println("Sorry No vacations Options Availavle!"+ '\n');
   }
   else {
      System.out.println("Availavle Vacations(in Month) : "+vacationOption+ '\n');
   }
   //------------------------------MY PART END ------------------------------//
   }
   }
